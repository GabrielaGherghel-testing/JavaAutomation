...
public class Main {
  ...
  public static void citireNote() {
    ...
    while (nota <= 0 || nota > 10) {
      System.out.println(
          "Nota " + nota + " nu este intre 1 si 10. Te rog introdu o valoare valida.");
  ...
  public static void printareValoriWhile() {
    ...
    while (valoare <= 5) {
      ...
      valoare++;
        System.out.println("Valoarea dupa parcurcerea de while este " + valoare);
    }
  }
  ...
  public static void printareValoriDoWhile() {
    ...
    System.out.println("Valoarea dupa parcurcerea de do-while este " + valoare);
  }
  public static void printaeValoriFor ()
  {
      //int valoare=1;
